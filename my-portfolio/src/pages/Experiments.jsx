              ...
              <div>
                <div className="relative">
                  <input
                    ...
                    className={`w-full pl-4 pr-12 py-3 bg-gray-50 dark:bg-gray-950 border ${
                      error ? 'border-red-500 focus:border-red-500 focus:ring-red-500/20' : 'border-gray-200 dark:border-gray-800 focus:border-primary-500 focus:ring-primary-500/20'
