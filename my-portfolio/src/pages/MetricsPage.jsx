            ...
            <div className="max-w-6xl mx-auto px-8 py-12">
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="grid md:grid-cols-4 gap-4 mb-8">
                        <motion.div whileHover={{ y: -5 }} className="bg-white/40 dark:bg-dark-surface/40 backdrop-blur-md border border-gray-300 dark:border-gray-800 rounded p-5 text-center hover:border-primary-500 dark:hover:border-primary-400 transition-all outline outline-2 outline-offset-4 outline-dark-bg outline-2">
                    ...
                    <motion.div
                        ...
                        className="bg-white/40 dark:bg-dark-surface/40 backdrop-blur-md border border-gray-300 dark:border-gray-800 rounded overflow-hidden shadow-lg"
                    >
                    ...
                    <div className="mt-8">
                        ...
                        <div className="grid md:grid-cols-3 gap-4">
                            <motion.div whileHover={{ y: -5, borderColor: isDarkMode ? '#ff4d4d' : '#ff4d4d', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)' }} className="bg-white/40 dark:bg-dark-surface/40 backdrop-blur-md border border-gray-300 dark:border-gray-800 rounded p-5 outline outline-2 outline-offset-4 outline-dark-bg outline-2">
